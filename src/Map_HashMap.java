...
public class Map_HashMap {
	...
	public static void main(String[] args) {
		 ...
		 * KEY : VALUE
		 * 
		 * "red" : "apple" "yellow" : "banana" "white" : "radish" "green" : "apple"
		 */
...
/*
 * Map: Interface HashMap: Class that implements interface Map
 *
 * class HashMap implements Map { ... }
 *
 * Map Properties: 1. They contain values based on key 2. They are not ordered
 * 3. "KEY" should be unique 4. "VALUE" can be duplicate
 */
